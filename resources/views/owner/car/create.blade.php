...
<form method="POST" action="{{ route('car.store') }}" id="myForm" enctype="multipart/form-data">
    @csrf 
        ...
        <div class="border-b border-gray-900/10 pb-4"> 
            <div class="mt-2 grid grid-cols-2 gap-x-4 gap-y-4">
                <div class="sm:col-span-1"> 
                    ...
                    <div class="mt-2"> 
                        <x-input id="name" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="name" placeholder="e.g. Viva,Proton,Myvi..." /> 
                    </div> 
                </div> 
                <div class="sm:col-span-1"> 
                    ...
                    <div class=" mt-2">
                        <x-input id="plate" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="plate" placeholder="e.g. WQE242..." />
                    </div>
                </div>
                <div class="sm:col-span-1">
                    <label for="seats" class="block text-xl font-medium leading-6 text-gray-900">Car seats <span class="text-red-500">*</span></label>
                    <div class="mt-2">
                        <x-input id="seats" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="seats" placeholder="Enter number of car seats"/>
                    </div>
                </div>
                <div class="sm:col-span-1">
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-2">
                        <select id="mode" name="mode"
                            class="bg-transparent text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5">
                            <option selected>Choose car mode</option>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-2">
                        <select id="status" name="status"
                            class="bg-transparent text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5">
                            <option selected>Choose car status</option>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-2">
                        <select id="aircond" name="aircond"
                            class="bg-transparent text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5">
                            <option selected>Air Conditioning / Heater</option>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-2">
                        <x-input type="text" id="pickup" name="pickup" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" list="locationSuggestions"/>
                ...
                <div class="sm:col-span-1"> 
                    ...
                    <div class=" mt-2">
                        <x-input id="luggage" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="luggage" placeholder="e.g. Insert number only" />
                    </div>
                </div>
                <div class="sm:col-span-1"> 
                    <label for="price" class="block text-xl font-medium leading-6 text-gray-900">Rental Price <span class="text-red-500">*</span></label>
                    <div class=" mt-2">
                        <x-input id="price" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="price" placeholder="Enter price per day" />
                    </div>
                </div>
                <div class="sm:col-span-1"> 
                    ...
                    <div class=" mt-2">
                        <x-input id="mileage" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="mileage" placeholder="e.g. Insert number only" />
                    </div>
                </div>
                <div class="sm:col-span-1"> 
                    ...
                    <div class=" mt-2">
                        <x-input id="date" class="block bg-transparent py-1.5 pl-1 flex-1 border border-gray-00 rounded-md mt-1 w-full sm:text-sm sm:leading-6" type="date" name="date" />
                    </div>
                </div>
