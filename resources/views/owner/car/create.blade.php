        ...
        <div class="border-b border-gray-900/10 pb-4"> 
            <div class="mt-2 grid grid-cols-2 gap-x-4 gap-y-4">
                <div class="sm:col-span-1"> 
                    ...
                    <div class="mt-2"> 
                        <x-input id="name" class="block bg-transparent py-1.5 pl-1 flex-1 text-gray-900 focus:ring-0 placeholder:text-gray-400 mt-1 w-full sm:text-sm sm:leading-6" type="text" name="name" placeholder="e.g. Viva" /> 
                    </div> 
                </div> 
                <div class="sm:col-span-1"> 
